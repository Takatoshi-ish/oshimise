...
import { loadViewerTeamId, saveViewerTeamId, clearViewerTeamId } from '@/lib/viewerTeam';
...
export default function HomePage() {
  ...
  // Default = "" (= 全チーム). Restored from localStorage on mount.
  ...
  return (
    <main className="md:flex md:gap-0 md:max-w-7xl md:mx-auto md:h-[calc(100vh-60px)] pb-16 md:pb-0">
      ...
      >
        ...
        {/* Mobile thin sub-bar with the team switcher */}
